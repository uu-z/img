// fork from https://github.com/alphasp/pixiv-api-client/blob/master/index.js

const axios = require('axios');
const qs = require('qs');

const { axiosProxy } = require("../utils")
...
class PixivApi {
    ...
    login(username, password, rememberPassword) {
        ...
        const options = { url: 'https://oauth.secure.pixiv.net/auth/token', method: 'POST', headers: { 'Content-Type': 'application/x-www-form-urlencoded' }, data };
        return axiosProxy(options).then((res) => {
